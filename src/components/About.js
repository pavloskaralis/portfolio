  ...
  return (
    <Wrapper id='About'>
      <SideA>
        <Title>About</Title>
        <Text>
        As a frontend developer, I’ve devoted a lot of time toward mastering the React framework and have implemented even its more obscure features many times over. Summarily, I’m practiced in building functional and class components, writing unit tests, implementing state containers, and stylizing with component libraries. My frontend knowledge does not end with React, however, since I’ve also built SPAs using Angular and Vue. I believe that learning these other frameworks has equipped me with a comparative understanding of React’s strengths. When it comes to backend, I’m equally confident in my ability to configure REST oriented APIs, and have done so using 6 different frameworks: Express, Firebase, Rails, Laravel, Django, and Spring Boot. I’ve integrated these applications with both noSQL and SQL databases, user authentication, and occasionally web sockets. In parallel with this freelance work, I also continue to develop my own online image editor: Appstractor, which is set to launch in the near future.  
        </Text>
        <IconWrap>
