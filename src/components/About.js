  ...
  return (
    <Wrapper id='about'>
      <SideA>
        <Title>About</Title>
        <Text>
        I’m a Full-Stack Developer capable of tackling a project from multiple-perspectives, and can dependably deliver tailored, maintainable results via a crafted approach. My General Assembly education has established a foundation that allows me to create quality software and effectively continue to grow my skills. To date, I have built several backends using Node.js, Java, PHP, and Ruby, along with frontends composed of React, Vue, Angular, and jQuery. 
          <br/><br/>
