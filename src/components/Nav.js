...
function Cover(){
    ...
    return (
        ...
        >
            <Title href='/' color={ (scroll >= (maxHeight * .12) && scroll <= (maxHeight * .23)) || (scroll >= (maxHeight * .725) && scroll <= (maxHeight * .86)) ? 'black' : 'white' }><div>Pavlos<span>Karalis</span></div></Title>
            <LinkWrap color={ (scroll >= (maxHeight * .12) && scroll <= (maxHeight * .23)) || (scroll >= (maxHeight * .725) && scroll <= (maxHeight * .86)) ? 'black' : 'white' }>
