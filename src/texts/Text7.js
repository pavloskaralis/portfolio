...
function Text7(){
  ...
  return (
    <span>
     Astral is a multi-room chat application that relies on <a target="_blank" rel="noopener noreferrer" href='https://github.com/pavloskaralis/chat-app/blob/master/venv/astral_server/astral_server/settings.py'>Django Channels</a> to create a live-update network. The website’s frontend is built using React and employs an organizational strategy of separating structures into views and components. In total, there exist 3 views that represent the app’s pages – Home, Lobby, and Chat – as well as 10 other reusable components within those structures. Users are able to access existing rooms within the Lobby view, or create their own public and private chats. These rooms accommodate for up to 8 users and are programmed to delete when empty.
      <br/><br/>
